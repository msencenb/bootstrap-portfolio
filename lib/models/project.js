...
(function() {
  ...
  module.exports = Project = (function() {
    ...
    function Project(name, description, image, long_description) {
      this.name = name;
    ...
    Project.prototype.pretty_id = function() {
